...
4. Self-Refine Loop:
   ...
   **Review**: Launch 4 agents in parallel with GATHERED_INFO, TICKET_PATH, and CONFIG (see ui-test-design skill for review criteria):
   - UI Wording Review (sonnet)
   - UI Behavior Review (sonnet)
   - UI Scenario Integration Review (sonnet)
   - UI Coverage Review (sonnet)
