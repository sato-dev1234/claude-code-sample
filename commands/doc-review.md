...
4. Launch agent to review the document:

   Agent 1: reviewing-documents haiku agent
   Review documentation following document-writer principles. Read ~/.claude/skills/reviewing-documents/SKILL.md and execute with GATHERED_INFO, TICKET_PATH, and CONFIG.
